...
import { useGetUsersQuery, useGetUserQuery } from '../../redux/userApi';
...
const LoadAccordion = ({ loadId, selectedUsers, setSelectedUsers, selectedTents, setSelectedTents }) => {
  ...
  const { data: loggedUser } = useGetUserQuery(user?._id);
  ...
  console.log('SELECTED USERS from Accordion: ', selectedUsers);
